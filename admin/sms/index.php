...
// KPI Stats from real notification_logs
$stat_pending = $pdo->query("SELECT COUNT(*) FROM notification_logs WHERE channel_used = 'sms' AND status = 'pending'")->fetchColumn();
$stat_sent = $pdo->query("SELECT COUNT(*) FROM notification_logs WHERE channel_used = 'sms' AND status IN ('sent', 'delivered')")->fetchColumn();
    ...
    <div class="col-12">
        <div class="dw-card">
            <div class="dw-card-header d-flex justify-content-between align-items-center">
                <span>Recent Cellular SMS Queue (<?php echo count($alerts); ?> Payload Records)</span>
            ...
            <div class="card-body p-0">
                ...
                <?php else: ?>
                    <div class="p-5 text-center text-muted">
                        ...
                        <h5>No SMS Queue Records</h5>
                        <p class="mb-0 small">No pending or sent SMS payloads recorded.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
