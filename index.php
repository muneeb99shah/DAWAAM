            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo BASE_URL; ?>/test_db.php" class="btn btn-warning btn-lg fw-bold px-4 py-2 text-dark">
                            <i class="bi bi-cpu me-2"></i> Run Phase 1 Diagnostic Test
                        </a>
                        <a href="<?php echo BASE_URL; ?>/admin/login.php" class="btn btn-outline-light btn-lg px-4 py-2">
...
<!-- Seed Pilot Business Overview -->
<div class="row g-4 mb-4">
    <div class="col-lg-7">
        <div class="dw-card p-4 h-100">
            <div class="d-flex align-items-center mb-3">
                <i class="bi bi-capsule-pill fs-2 me-3" style="color:#0f766e;"></i>
                <div>
                    <h4 class="fw-bold mb-0 text-dark">Initial Target Business: Pilot Pharmacy</h4>
                    <span class="badge bg-light text-dark border">Quetta Medical & Pharmacy Store</span>
                </div>
            </div>
            <p class="text-muted mb-4">
                Dawaam is pre-configured with a pilot pharmacy model managing medicine stock, low-stock thresholds (e.g. Insulin), sales receipts, and emergency alerts.
            </p>
            <div class="row g-3">
                <div class="col-sm-6">
                    <div class="dw-stat-card">
                        <div class="dw-stat-label">Initial Seed Products</div>
                        <div class="dw-stat-value">4 Items</div>
                        <span class="small text-muted">Humulin Insulin, Amoxicillin, etc.</span>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="dw-stat-card stat-amber">
                        <div class="dw-stat-label">Low Stock Threshold</div>
                        <div class="dw-stat-value">5 Units</div>
                        <span class="small text-muted">Triggers urgent alert</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-5">
        <div class="dw-card p-4 h-100">
            <h4 class="fw-bold mb-3 d-flex align-items-center text-dark">
                <i class="bi bi-shield-check text-success me-2"></i> System Seed Accounts
            </h4>
            <p class="text-muted small mb-3">Use the pre-configured credentials below to test system authentication during development:</p>

            <div class="mb-3 p-3 bg-light rounded border">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <strong class="text-dark">Super Admin</strong><br>
                        <span class="text-muted small">Username: <code>admin</code></span>
                    </div>
                    <span class="badge bg-dark px-3 py-2 font-monospace">Password: Admin@1234</span>
                </div>
            </div>
            ...
            <div class="p-3 bg-light rounded border">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <strong class="text-dark">Pharmacist Account</strong><br>
                        <span class="text-muted small">Username: <code>tariq_pharm</code></span>
                    </div>
                    <span class="badge bg-secondary px-3 py-2 font-monospace">Password: Admin@1234</span>
                </div>
            </div>
        </div>
    </div>
